...
class VerifyView(discord.ui.View):
    ...
    async def verify_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        await interaction.response.send_message("📋 Rozpoczynam weryfikację! Wysyłam Ci pytania na PV...", ephemeral=True)
...
async def verify_cmd(interaction: discord.Interaction):
    user = interaction.user
    await interaction.followup.send("📋 Rozpoczynam weryfikację! Wysyłam Ci pytania na PV...", ephemeral=True)
